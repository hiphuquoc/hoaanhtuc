...
class BrandController extends Controller {
    ...
    public function create(BrandRequest $request){
        try {
            ...
            $message        = [
                'type'      => 'success',
                'message'   => '<strong>Thành công!</strong> Dã tạo Nhãn hàng mới'
            ];
    ...
    public static function list(Request $request){
        ...
        /* paginate */
        $viewPerPage        = Cookie::get('viewBrandInfo') ?? 20;
        $params['paginate'] = $viewPerPage;
        $list               = Brand::getList($params);
        return view('admin.brand.list', compact('list', 'viewPerPage', 'params'));
    }
}
